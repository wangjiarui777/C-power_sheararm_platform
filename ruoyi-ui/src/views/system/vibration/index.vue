...
.panel{padding:12px;border:1px solid #273846;border-radius:10px;background:#15212c}.toolbar{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:12px 0}.selectors,.toolbar-actions{display:flex;gap:8px}.selectors .el-select:first-child{width:240px}.selectors .el-select:last-child{width:180px}
...
.quality-banner{display:flex;justify-content:space-between;margin-bottom:8px;padding:8px 10px;border-left:3px solid #71808d;background:#101a23;color:#8ea2b3;font-size:12px}.quality-banner.good{border-color:#32b67a}.quality-banner.stale{border-color:#e7a23b}.quality-banner.bad,.quality-banner.offline{border-color:#e05252}.quality-banner strong{color:#cbd8e1}
.analysis-chart{height:570px;border:1px solid #22323e;border-radius:8px;background:#101a23}.chart-empty{position:absolute;inset:54% 0 auto;color:#718696;text-align:center;pointer-events:none}
.feature-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.feature-grid>div{padding:10px;border:1px solid #283a48;border-radius:8px;background:#101a23}.feature-grid span,.feature-grid small{display:block;color:#8195a6;font-size:11px}.feature-grid strong{display:block;margin:6px 0 2px;font-family:"DIN Alternate",Consolas,monospace;font-size:22px}
.rule-card h3{margin:0 0 10px;font-size:15px}.rule-values{display:flex;gap:8px}.rule-values span{flex:1;padding:8px;border:1px solid #2b3d4b;border-radius:6px;color:#8ea2b3}.rule-values b{display:block;margin-top:4px;color:#dce7ee;font-family:Consolas,monospace}.rule-card p{margin:10px 0 0;color:#9eb0be;font-size:12px;line-height:1.6}
.alarm-list{display:grid;gap:7px}.alarm-list button{display:grid;grid-template-columns:8px minmax(0,1fr);gap:9px;padding:9px;border:1px solid #2b3d4b;border-radius:7px;background:#101a23;color:#dce7ee;text-align:left;cursor:pointer}.alarm-list i{width:7px;height:7px;margin-top:4px;border-radius:50%;background:#e7a23b}.alarm-list i.alarm{background:#e05252}.alarm-list strong,.alarm-list small{display:block}.alarm-list small{margin-top:3px;color:#8195a6}.empty-card{padding:16px;color:#718696;text-align:center}
