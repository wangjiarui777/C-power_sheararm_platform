    ...
    <main class="lc-grid">
      ...
      <section class="designer-stage">
        <el-tabs v-if="current.id" v-model="activeWorkspace" class="workspace-tabs">
          ...
          <el-tab-pane v-if="!isPipeline" label="权限" name="permissions">
