...
FROM (
    ...
    UNION ALL SELECT '文件台账查询',@vibration_menu,6,'sensor:ingest:list'
    UNION ALL SELECT '文件关联',@vibration_menu,7,'sensor:ingest:associate'
    UNION ALL SELECT '失败重试',@vibration_menu,8,'sensor:ingest:retry'
