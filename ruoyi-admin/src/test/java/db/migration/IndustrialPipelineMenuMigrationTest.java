...
class IndustrialPipelineMenuMigrationTest
{
    ...
    void createsDeterministicRoutesWithoutChangingExistingRoleGrants() throws Exception
    {
        try (Connection connection = connection(); Statement statement = connection.createStatement())
        {
            ...
            statement.execute("INSERT INTO sys_menu(menu_id,menu_name,parent_id,order_num,path,menu_type) VALUES(20,'旧数据接入',0,8,'sensor-access','M'),(21,'重复数据接入',0,9,'sensor-access','M')");
